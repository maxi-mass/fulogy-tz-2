...
var Content = function Content(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    setTimeout(function () {
      if (yellowСircle.opDirection === "down" && yellowСircle.opacity > 0.1) {
        setYellowСircle(function (prev) {
          return {
            opacity: Number((prev.opacity - 0.04).toFixed(2)),
            opDirection: prev.opDirection
          };
        });
      } else if (yellowСircle.opDirection === "down" && yellowСircle.opacity <= 0.1) {
        setYellowСircle(function (prev) {
          return {
...
//# sourceMappingURL=index.js.cf578137df51c2e8713f.hot-update.js.map